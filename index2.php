...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>La Cocina de Martoc</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Talleres de cocina Nacional e internacional con una gran variedad de platos aprendiendo tecnicas del arte de cocinar">
...
<div id="myCarousel" class="carousel slide homCar">
		<div class="carousel-inner" style="border-top:18px solid #222; border-bottom:1px solid #222; border-radius:4px;">
		  <div class="item active">
			<img src="images/Panama.langostasobrepapitacriolla.jpg" alt="#" style="min-height:250px; min-width:100%"/>
			<div class="carousel-caption">
				  <h4>Taller de Cocina</h4>
				  <p>Lorem ipsum dolor sit amet,
				   consectetur adipisicing elit.
				    Consequatur nulla quod optio,
				     blanditiis aperiam culpa dolorem! 
				     Suscipit non ratione quas, libero 
				     quo ullam molestias laborum soluta perferendis error vitae impedit.</p>
				  
			</div>
		  </div>
		  <div class="item">
			<img src="images/fi_gourmet1.jpg" alt="#" style="min-height:250px; min-width:100%"/>
			<div class="carousel-caption">
				  <h4>El Arte de la Cocina</h4>
				  <p>
				    Lorem ipsum dolor sit amet,
				     consectetur adipisicing elit.
				      Et consequatur iusto ipsum rem,
				       doloremque, mollitia autem laboriosam.
				        </p>
			</div>
		  </div>
		  <div class="item">
			<img src="images/plato1.jpg" alt="#" style="min-height:250px; min-width:100%"/>
			<div class="carousel-caption">
				  <h4>Gourmet </h4>
				  <p>
				  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita ratione sapiente quaerat aut, nobis. Vitae quidem nihil sunt ab repellendus, vero architecto natus ipsa dolorem ea voluptas nisi ut aliquam.
				  </p>
			</div>
		  </div>
		</div>
...
<hr class="soften"/>
<p>&copy; Copyright La Cocina de Martoc C.A. <br/><br/></p>
 </footer>
</div><!-- /container -->
