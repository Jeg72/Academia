...
<head>
	...
	<title>La Cocina de Martoc C.A.</title>
</head>
<body>
	    <center><div class="tit puntos_bg"><h2 style="color: #BDFC03; ">Ingresa al Sitio</h2>
...
<form method="post" action="" >
  <fieldset>
    <legend  style="font-size: 18pt color: #000;"><b>Registro</b></legend>
    <div class="form-group">
      <label style="font-size: 14pt color: #000;"><b>Ingresa tu nombre</b></label>
      <input type="text" name="realname" class="form-control" required placeholder="Ingresa tu nombre" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt color: #000;"><b>Ingresa tu email</b></label>
      <input type="text" name="nick" class="form-control"  required placeholder="Ingresa mail"/>
    </div>
    <div class="form-group">
      <label style="font-size: 14pt color: #000;"><b>Ingresa tu Password</b></label>
      <input type="password" name="pass" class="form-control"  placeholder="Ingresa contraseña" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt color: #000;"><b>Repite tu contraseña</b></label>
